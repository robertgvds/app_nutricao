...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _fazerLogin() async {
    ...
    try {
      ...
      if (e.code == 'user-not-found' || e.code == 'invalid-email') mensagem = "E-mail não cadastrado.";
      if (e.code == 'wrong-password' || e.code == 'invalid-credential') mensagem = "Senha incorreta.";
  ...
  void _mostrarDialogoVerificacao() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Seu cadastro ainda não está ativo. Por favor, clique no link enviado para o seu e-mail para validar sua conta."),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text("OK", style: TextStyle(color: AppColors.roxoEscuro)),
          ),
          TextButton(
            onPressed: () async {
            ...
            child: const Text("Entendi", style: TextStyle(color: AppColors.verdeEscuro)),
          ),
        ],
      ),
    );
  ...
  Widget _buildLoginTextField(String hint, TextEditingController controller, {bool obscure = false}) {
    return Padding(
          ...
          children: [
            ...
            Column(
              children: [
                ...
                const SizedBox(height: 20),
                const Text("Login", style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: AppColors.preto)),
                const SizedBox(height: 30),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _estaCarregando
                        ...
                        : const Text("Entrar", style: TextStyle(color: AppColors.branco, fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
                ),
                ...
                Align(
                  ...
                  child: TextButton(
                    ...
                    child: const Text("Esqueci a senha", style: TextStyle(color: AppColors.verdeEscuro, decoration: TextDecoration.underline)),
                  ),
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: const Text("Cadastre-se", style: TextStyle(color: AppColors.roxoEscuro, fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],
